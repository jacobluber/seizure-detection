...
def calculating_stat(loader):
        ...
        np.savetxt(path.join("/home/axh5735/projects/signal_compression/logs/compression_128_256/stat", "std.gz"), tot_Std.numpy())
        np.savetxt(path.join("/home/axh5735/projects/signal_compression/logs/compression_128_256/stat", "mean.gz"), tot_Mean.numpy())
